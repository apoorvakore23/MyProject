...
<div class="row">
<div class="col-sm-6">
<form:form  modelAttribute="category" enctype="form-data" role="form" action="deleteCategorytrue/${supplier.id }" method="post">
...
<div class="col-sm-6">
<form:form action="dispCategory" method="get" role="form">
