					...
					<table class="table table-hover">
						...
						<tbody>								
									...
									<td><img src="<c:url value='/assets/Multipath/{{product.file}}'/>"  alt="noImage" class="img-thumbnail" ></td>
										...
										<td><a href="${pageContext.request.contextPath}/details/{{product.id}}" class="btn btn-info">View</a> <br><br><sec:authorize access="hasRole('ROLE_ADMIN')"> 
											
												<a href="${pageContext.request.contextPath}/edit/{{product.id}}" class="btn btn-warning">Edit</a><br><br>
											
												<a href="${pageContext.request.contextPath}/delete/{{product.id}}" class="btn btn-danger">Delete</a></sec:authorize>
