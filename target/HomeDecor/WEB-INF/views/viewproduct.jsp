					...
					<table class="table table-hover">
						...
						<tbody>								
									...
									<td><img src="<c:url value='/assets/Multipath/{{product.file}}'/>"  alt="noImage" class="img-thumbnail" ></td>
										...
										<td><a href="${pageContext.request.contextPath}/details/{{product.id}}?id={{product.id}}" class="btn btn-info btn3d">View</a> <br><br><sec:authorize access="hasRole('ROLE_ADMIN')"> 
