	...
	<div class="navbar navbar-inverse  navbar-fixed-top " >
		<div class="container">
			...
			<div class="navbar-collapse collapse">
					...
					<li class="dropdown">
					<a  href="${pageContext.request.contextPath}/#" class="dropdown-toggle" data-toggle="dropdown" href="#">Products<span class="caret"></span></a>
					...
					<li class="dropdown">
					<a  href="${pageContext.request.contextPath}/add" class="dropdown-toggle" data-toggle="dropdown" href="#">Product Details<span class="caret"></span></a>
					<ul class="dropdown-menu">
			          <li><a href="${pageContext.request.contextPath}/add">Add Product</a></li>
